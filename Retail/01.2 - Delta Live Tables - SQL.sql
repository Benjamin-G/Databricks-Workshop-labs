...
AS SELECT * FROM cloud_files("/Volumes/main/eric_edwards_databricks_com_retail/retail/events", "csv", map("cloudFiles.inferColumnTypes", "true"))
...
AS SELECT * FROM cloud_files("/Volumes/main/eric_edwards_databricks_com_retail/retail/orders", "json", map("cloudFiles.inferColumnTypes", "true"))
...
AS SELECT * FROM cloud_files("/Volumes/main/eric_edwards_databricks_com_retail/retail/users", "json", map("cloudFiles.inferColumnTypes", "true"))
